...
def test_create_data_model_successful(schema_json, expected_type):
  ...
  data_cls = models.create_data_model(schema, WrapperClass, core.AvroModelContainer())
...
def test_record_schema_model():
  ...
  record_cls = models.create_data_model(schema, WrapperClass, core.AvroModelContainer())
